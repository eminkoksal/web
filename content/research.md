...
## Section 2 — Method Signature

*(Treat this as a defining statement — visually set apart from surrounding sections.)*
...
## Section 4 — Selected Earlier Publications
...
Consider `#flagship`, `#publications`, `#interests` for in-page navigation if the page gets long enough.

## External links

All SSRN, Routledge, and journal links should open in a new tab.

## Long-term

As the AI-Native Research program grows, this page should evolve from "two flagship projects" into a project index. Keep the Method Signature section stable; it's the page's editorial anchor.
