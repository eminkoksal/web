...
> One identity. Four reinforcing pillars.

**Intro paragraph**

> The work splits cleanly into four pillars — but they pull on the same expertise and reinforce each other. Academic credibility earns the right to speak; AI fluency makes the speaking current.
...
- `Get in touch →` *(to /contact, primary)*
- `Connect on LinkedIn` *(secondary, opens LinkedIn)*
